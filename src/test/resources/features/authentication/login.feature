...
Feature: Login Page
  ...
  @smoke @regression
  Scenario: Verify that "locked_out_user" displays an error message
  ...
  Scenario: Verify that empty fields displays an error message
    When the user clicks the "login" button
    Then the error message "Epic sadface: Username is required" should be displayed
    And the "error close" "button" should be displayed

  Scenario: Verify that clicking on the error close button remove it
    When the user clicks the "login" button
    Then the error message "Epic sadface: Username is required" should be displayed
    And the "error close" "button" should be displayed
    When the user clicks the "error close" button
    Then the "error close" "button" should not be displayed